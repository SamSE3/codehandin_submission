 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignfeedback_codehandin_batch_upload_files_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'batchuploadfilesforusers', get_string('batchuploadfilesforusers', 'assignfeedback_codehandin',
            count($params['users'])));
        $mform->addElement('static', 'userslist', get_string('selectedusers', 'assignfeedback_codehandin'), $params['usershtml']);
        ...
        $data = file_prepare_standard_filemanager($data,
                                                  ...
                                                  assignfeedback_codehandin_BATCH_FILEAREA, $USER->id);
        ...
        $mform->addElement('hidden', 'plugin', 'codehandin');
        ...
        $this->add_action_buttons(true, get_string('uploadfiles', 'assignfeedback_codehandin'));

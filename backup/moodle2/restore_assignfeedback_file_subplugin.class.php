 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignfeedback_codehandin_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_assignfeedback_codehandin_grade($data) {
        global $DB;
        ...
        $DB->insert_record('assignfeedback_codehandin', $data);

        $this->add_related_files('assignfeedback_codehandin', 'feedback_files', 'grade', null, $oldgradeid);
    }

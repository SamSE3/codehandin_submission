 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_assignfeedback_codehandin_subplugin extends backup_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
        ...
        $subpluginelement->set_source_table('assignfeedback_codehandin', array('grade' => backup::VAR_PARENTID));
        // The parent is the grade.
        $subpluginelement->annotate_files('assignfeedback_codehandin', 'feedback_files', 'grade');
        return $subplugin;
    }

 ...
 * @param assignsubmission_codehandin_mod_form $mform
 * @return int The id of the newly inserted codehandin record
 */
function codehandin_add_instance(stdClass $codehandin, assignsubmission_codehandin_mod_form $mform = null) {
    global $DB;
 ...
 */
function codehandin_update_instance(stdClass $codehandin, assignsubmission_codehandin_mod_form $mform = null) {
    global $DB;
...
function codehandin_delete_instance($id) {
    ...
    $DB->delete_records('codehandin_checkpoint',array('assignmentid'=>$codehandin->id));
...
function codehandin_update_grades(stdClass $codehandin, $userid = 0) {
    ...
    /** @example */
    if (!$userid) {
        $result = $DB->get_records("codehandin_submission");
